            ...
            <div className="p-6 md:p-8 overflow-y-auto grow" data-lenis-prevent="true">
              {step === 0 && (
                <motion.div 
                  ...
                  className="space-y-4"
                >
                  <h3 className="text-lg md:text-xl font-heading font-semibold text-brand-dark mb-4 md:mb-6">Como você prefere falar com a gente?</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    ...
                    >
                       ...
                       <div>
                         <p className="font-bold text-brand-dark mb-0.5 md:mb-2 text-base md:text-lg">Preencher formulário</p>
                         <p className="text-xs md:text-sm text-gray-600">Responda um quiz rápido para já chegarmos com uma proposta ideal.</p>
                       </div>
                    </button>
                    ...
                    >
                       ...
                       <div>
                         <p className="font-bold text-brand-dark mb-0.5 md:mb-2 text-base md:text-lg">Mensagem direta</p>
                         <p className="text-xs md:text-sm text-gray-600">Fale com um consultor agora mesmo sem preencher nada.</p>
                       </div>
                    </button>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 outline-none transition-all text-brand-dark"
              ...
              <div className="bg-gray-50 p-4 sm:px-8 border-t border-gray-100 flex justify-between items-center shrink-0">
                 ...
                 {step < 4 ? (
                   ...
                   <button 
                    ...
                    className="px-6 py-3 bg-brand-accent text-brand-dark rounded-lg font-bold hover:bg-[#00c0e6] shadow-[0_0_15px_rgba(0,212,255,0.4)] transition-all flex items-center gap-2"
                   >
