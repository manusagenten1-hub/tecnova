          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative h-48 md:h-64 overflow-hidden bg-gray-100 border-b border-gray-100">
                ...
                />
                <div className="absolute top-3 right-3 md:top-4 md:right-4 z-20 bg-brand-dark/90 backdrop-blur-sm text-brand-accent border border-brand-accent/20 text-[10px] md:text-xs font-bold px-3 py-1.5 rounded-full uppercase tracking-wide shadow-neon transform group-hover:translate-y-1 transition-transform duration-300">
                  {project.tag}
                </div>
              </div>
