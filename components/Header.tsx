  ...
  return (
    <motion.nav 
      ...
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 transform-gpu ${
        isScrolled 
          ? 'bg-brand-dark/90 backdrop-blur-xl shadow-neon border-b border-brand-accent/10 py-2' 
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="relative overflow-hidden group bg-brand-accent/10 border border-brand-accent text-brand-accent px-6 py-2.5 rounded-full font-semibold transition-all duration-500 hover:text-brand-dark hover:shadow-neon"
            >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div 
              ...
              className="md:hidden absolute top-full left-0 w-full bg-brand-dark/95 backdrop-blur-xl border-t border-brand-accent/20 shadow-xl max-h-[85vh] overflow-y-auto"
            >
              <div className="flex flex-col p-6 gap-6">
                ...
                <motion.button 
                  ...
                  className="bg-brand-accent text-center text-brand-dark py-4 rounded-xl font-bold shadow-neon mt-4 w-full"
                >
                  Começar Meu Projeto
                </motion.button>
              </div>
